...
help:
	...
	@printf '  postgresql.queries      re-ejecuta las 6 consultas representativas\n'
	@printf '  postgresql.checks       24 controles de estado\n'
	@printf '  postgresql.integrity    17 pruebas de integridad\n'
